    ...
    return (
        <>
            ...
            <div className="p-6 md:p-0 w-full md:w-[456px] mt-20 mx-auto flex flex-col gap-4">
                ...
                <p className="text-center text-muted-foreground">Your account has been set up. The <span className="text-foreground">username</span> and <span className="text-foreground">password</span> have been sent to your registered email address.</p>
